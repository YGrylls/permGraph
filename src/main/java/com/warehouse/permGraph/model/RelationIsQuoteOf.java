...
@RelationshipEntity("IS_QUOTE_OF")
public class RelationIsQuoteOf implements IRel {
	@Id
	private Long id;
	...
	public RelationIsQuoteOf() {

	}

	@Override
	public String toString() {
		return "RelationIsQuoteOf [id=" + id + ", title=" + title + ", start=" + start + ", end=" + end + "]";
	}
