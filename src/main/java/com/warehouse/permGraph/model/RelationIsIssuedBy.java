...
@RelationshipEntity("IS_ISSUED_BY")
public class RelationIsIssuedBy implements IRel {
	@Id
	private Long id;
	...
	public RelationIsIssuedBy() {

	}

	@Override
	public String toString() {
		return "RelationIsIssuedBy [id=" + id + ", title=" + title + ", start=" + start + ", end=" + end + "]";
	}
