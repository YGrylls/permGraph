...
@RelationshipEntity("HAS_BROADER")
public class RelationHasBroader implements IRel {
	@Id
	private Long id;
	...
	public RelationHasBroader() {

	}

	@Override
	public String toString() {
		return "RelationHasBroader [id=" + id + ", title=" + title + ", start=" + start + ", end=" + end + "]";
	}
